...
let DeleteController = class DeleteController {
    constructor(getDeleteService) {
        this.getDeleteService = getDeleteService;
    }
    fetchDeleteService(request) {
...
], DeleteController.prototype, "fetchDeleteService", null);
DeleteController = __decorate([
    (0, common_1.Controller)('/upload/image/delete'),
    __metadata("design:paramtypes", [delete_service_1.DeleteService])
], DeleteController);
